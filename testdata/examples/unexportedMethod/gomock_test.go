...
func (m *Mockexample) unexportedMethod(test unexportedMethod.unexportedType) {
	m.ctrl.T.Helper()
...
func (c *exampleunexportedMethodCall) Do(f func(unexportedMethod.unexportedType)) *exampleunexportedMethodCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *exampleunexportedMethodCall) DoAndReturn(f func(unexportedMethod.unexportedType)) *exampleunexportedMethodCall {
